/* ext4_image.h -- libext2fs-backed dump/inject/verify of a file inside an
 * ext4 rootfs image: dump a file out of the rootfs, inject
 * (replace-or-create) a file into it, and a basic self-consistency check.
 *
 * Validated directly against real e2fsprogs tools before being wired into
 * the rest of core/: a synthetic ext4 image (modern mke2fs defaults --
 ...
 * file type bit is added internally). Matches the old Python pipeline's

...
#    selected --model (default: pedalboard; also mx5, gigboard).
...
echo "Downloading stock HeadRush Windows updater ($MODEL)..."
...
"$DIR/scripts/build_docker.sh" "$STOCK_IMG" "$WORK/Update_nam.img" --model "$MODEL"
